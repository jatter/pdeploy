...
<form id="form-new" method="post" action="${pageContext.request.contextPath}/systemparam/insert" style="flex: 1 0 auto;">
  <div class="container" style="padding-top: 20px;">
    <div class="row">
      <div class="col s12">
        <div class="card">
          <div class="card-content">
            <span class="card-title black-text">新建参数</span>
            <div class="row">
              <div class="input-field col s6" style="display:none;">
                <input type="hidden" id="input-uuid" name="uuid" value="${projectId}">
                <input type="text" id="input-parameter_id" name="parameter_id" value=null>
              </div>
              <div class="input-field col s6">
                <input type="text" id="input-parameter_name" name="parameter_name">
                <label for="input-parameter_name">参数名称</label>
              </div>
              <div class="input-field col s6">
                <input type="text" id="input-parameter_value" name="parameter_value">
                <label for="input-parameter_value">参数值</label>
              </div>
              <div class="input-field col s6">
                <input type="text" id="input-parameter_path" name="parameter_path">
                <label for="input-parameter_path">参数路径</label>
              </div>
              <div class="input-field col s6">
                <input type="text" id="input-regular" name="regular">
